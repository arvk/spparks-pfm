...
AppMetfilm::AppMetfilm(SPPARKS *spk, int narg, char **arg) : 
...
void AppMetfilm::input_app(char *command, int narg, char **arg)
{
  if (strcmp(command,"event") == 0) {
    ...
    if (rstyle == 1) {
      ...
      if (strcmp(arg[2],"fe") == 0) sinput[none] = FE;
      else if (strcmp(arg[2],"h") == 0) sinput[none] = HYDROGEN;
      else if (strcmp(arg[2],"hmol") == 0) sinput[none] = FEHMOL;
      else if (strcmp(arg[2],"vac") == 0) sinput[none] = VACANCY;
      else if (strcmp(arg[2],"sup") == 0) sinput[none] = SUP;
      else error->all(FLERR,"Illegal event command");

      srate[none] = atof(arg[3]);

      if (strcmp(arg[4],"fe") == 0) soutput[none] = FE;
      else if (strcmp(arg[4],"h") == 0) soutput[none] = HYDROGEN;
      else if (strcmp(arg[4],"hmol") == 0) soutput[none] = FEHMOL;
      else if (strcmp(arg[4],"vac") == 0) soutput[none] = VACANCY;
      else if (strcmp(arg[4],"sup") == 0) soutput[none] = SUP;
      else error->all(FLERR,"Illegal event command");
      ...
      if (strcmp(arg[3],"fe") == 0) dinput[ntwo][0] = FE;
      else if (strcmp(arg[3],"h") == 0) dinput[ntwo][0] = HYDROGEN;
      else if (strcmp(arg[3],"hmol") == 0) dinput[ntwo][0] = FEHMOL;
      else if (strcmp(arg[3],"vac") == 0) dinput[ntwo][0] = VACANCY;
      else if (strcmp(arg[3],"sup") == 0) dinput[ntwo][0] = SUP;
      else error->all(FLERR,"Illegal event command");
      if (strcmp(arg[4],"fe") == 0) dinput[ntwo][1] = FE;
      else if (strcmp(arg[4],"h") == 0) dinput[ntwo][1] = HYDROGEN;
      else if (strcmp(arg[4],"hmol") == 0) dinput[ntwo][1] = FEHMOL;
      else if (strcmp(arg[4],"vac") == 0) dinput[ntwo][1] = VACANCY;
      else if (strcmp(arg[4],"sup") == 0) dinput[ntwo][1] = SUP;
      else error->all(FLERR,"Illegal event command");

      drate[ntwo] = atof(arg[5]);

      if (strcmp(arg[6],"fe") == 0) doutput[ntwo][0] = FE;
      else if (strcmp(arg[6],"h") == 0) doutput[ntwo][0] = HYDROGEN;
      else if (strcmp(arg[6],"hmol") == 0) doutput[ntwo][0] = FEHMOL;
      else if (strcmp(arg[6],"vac") == 0) doutput[ntwo][0] = VACANCY;
      else if (strcmp(arg[6],"sup") == 0) doutput[ntwo][0] = SUP;
      else error->all(FLERR,"Illegal event command");
      if (strcmp(arg[7],"fe") == 0) doutput[ntwo][1] = FE;
      else if (strcmp(arg[7],"h") == 0) doutput[ntwo][1] = HYDROGEN;
      else if (strcmp(arg[7],"hmol") == 0) doutput[ntwo][1] = FEHMOL;
      else if (strcmp(arg[7],"vac") == 0) doutput[ntwo][1] = VACANCY;
      else if (strcmp(arg[7],"sup") == 0) doutput[ntwo][1] = SUP;
      else error->all(FLERR,"Illegal event command");
      ...
      if (strcmp(arg[4],"fe") == 0) tinput[nthree][0] = FE;
      else if (strcmp(arg[4],"h") == 0) tinput[nthree][0] = HYDROGEN;
      else if (strcmp(arg[4],"hmol") == 0) tinput[nthree][0] = FEHMOL;
      else if (strcmp(arg[4],"vac") == 0) tinput[nthree][0] = VACANCY;
      else if (strcmp(arg[4],"sup") == 0) tinput[nthree][0] = SUP;
      else error->all(FLERR,"Illegal event command");
      if (strcmp(arg[5],"fe") == 0) tinput[nthree][1] = FE;
      else if (strcmp(arg[5],"h") == 0) tinput[nthree][1] = HYDROGEN;
      else if (strcmp(arg[5],"hmol") == 0) tinput[nthree][1] = FEHMOL;
      else if (strcmp(arg[5],"vac") == 0) tinput[nthree][1] = VACANCY;
      else if (strcmp(arg[5],"sup") == 0) tinput[nthree][1] = SUP;
      else error->all(FLERR,"Illegal event command");
      if (strcmp(arg[6],"fe") == 0) tinput[nthree][2] = FE;
      else if (strcmp(arg[6],"h") == 0) tinput[nthree][2] = HYDROGEN;
      else if (strcmp(arg[6],"hmol") == 0) tinput[nthree][2] = FEHMOL;
      else if (strcmp(arg[6],"vac") == 0) tinput[nthree][2] = VACANCY;
      else if (strcmp(arg[6],"sup") == 0) tinput[nthree][2] = SUP;
      else error->all(FLERR,"Illegal event command");

      trate[nthree] = atof(arg[7]);

      if (strcmp(arg[8],"fe") == 0) toutput[nthree][0] = FE;
      else if (strcmp(arg[8],"h") == 0) toutput[nthree][0] = HYDROGEN;
      else if (strcmp(arg[8],"hmol") == 0) toutput[nthree][0] = FEHMOL;
      else if (strcmp(arg[8],"vac") == 0) toutput[nthree][0] = VACANCY;
      else if (strcmp(arg[8],"sup") == 0) toutput[nthree][0] = SUP;
      else error->all(FLERR,"Illegal event command");
      if (strcmp(arg[9],"fe") == 0) toutput[nthree][1] = FE;
      else if (strcmp(arg[9],"h") == 0) toutput[nthree][1] = HYDROGEN;
      else if (strcmp(arg[9],"hmol") == 0) toutput[nthree][1] = FEHMOL;
      else if (strcmp(arg[9],"vac") == 0) toutput[nthree][1] = VACANCY;
      else if (strcmp(arg[9],"sup") == 0) toutput[nthree][1] = SUP;
      else error->all(FLERR,"Illegal event command");
      if (strcmp(arg[10],"fe") == 0) toutput[nthree][2] = FE;
      else if (strcmp(arg[10],"h") == 0) toutput[nthree][2] = HYDROGEN;
      else if (strcmp(arg[10],"hmol") == 0) toutput[nthree][2] = FEHMOL;
      else if (strcmp(arg[10],"vac") == 0) toutput[nthree][2] = VACANCY;
      else if (strcmp(arg[10],"sup") == 0) toutput[nthree][2] = SUP;
      else error->all(FLERR,"Illegal event command");
...
void AppMetfilm::init_app()
{
  ...
  for (int i = 0; i < nlocal; i++) {
    ...
    if (element[i] < FE || element[i] > SDOWN) flag = 1;
  }
  int flagall;
...
double AppMetfilm::site_energy(int i)
{
  return 0.0;
}
...
double AppMetfilm::site_propensity(int i)
{
  int j,k,m;
...
void AppMetfilm::site_event(int i, class RandomPark *random)
{
  int j,k,m,n;
...
void AppMetfilm::clear_events(int i)
{
  int next;
...
void AppMetfilm::add_event(int i, int rstyle, int which, double propensity,
...
void AppMetfilm::grow_reactions(int rstyle)
{
  if (rstyle == 1) {
    int n = none + 1;
