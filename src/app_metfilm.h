...
#ifdef APP_CLASS
AppStyle(metfilm,AppMetfilm)

#else

#ifndef SPK_APP_METFILM_H
#define SPK_APP_METFILM_H

#include "app_lattice.h"

namespace SPPARKS_NS {

class AppMetfilm : public AppLattice {
  friend class DiagMetfilm;

 public:
  AppMetfilm(class SPPARKS *, int, char **);
  ~AppMetfilm();
...
E: Temperature cannot be 0.0 for app metfilm
