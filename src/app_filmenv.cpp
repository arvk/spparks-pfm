...
double AppFILMENV::site_energy(int i)
{
  int j,isite,jsite;
...
void AppFILMENV::site_event(int i, class RandomPark *random)
{
...
void AppFILMENV::clear_events(int i)
{
  int next;
...
void AppFILMENV::add_event(int i, int partner, double propensity, int incre)
{
